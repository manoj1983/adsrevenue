...
const Blog = () => {
  ...
  // 💡 'useQuery' data ko fetch aur cache karta hai
  const { 
  ...
  // 💡 Search filter ab 'posts' (jo 'data' hai) par kaam karega
  const filteredPosts = (posts || []).filter((post: any) => { // 'post: any' type add kiya
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-20">
        {/* 🔹 Hero Section (Aapka purana code yahaan) */}
        ...
        <section ref={postsRef} className="py-16 bg-white">
          <div className="container mx-auto px-4 md:px-6">
            ...
            {isLoading ? (
              ...
              // Agar error aaye toh message dikhayein
        ...
        {/* 🔹 Newsletter Section (Aapka purana code yahaan) */}
